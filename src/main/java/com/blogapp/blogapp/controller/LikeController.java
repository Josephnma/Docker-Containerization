...
public class LikeController {
    ...
    public ResponseEntity<String> creatLike(@PathVariable(value = "postId") Long postId, HttpSession session){
        PersonDto personDto = new PersonDto();
//        if(personDto.getRole().equals("CUSTOMER")){
            String message = likeService.createLike(personDto.getId(), postId, session);
