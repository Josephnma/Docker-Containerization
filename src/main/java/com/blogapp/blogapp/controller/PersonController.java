...
public class PersonController {
    ...
    public ResponseEntity<PersonDto> getPersonById(@PathVariable(name = "personId") Long personId, HttpSession session){
//        PersonDto personDto = new PersonDto();
//                (PersonDto) session.getAttribute("person");
        return  personService.getPersonById(personId, session);
        //        return null;
    }
    @PostMapping("/login")
